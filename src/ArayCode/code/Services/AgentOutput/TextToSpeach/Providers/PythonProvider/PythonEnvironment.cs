...
public sealed class PythonEnvironment
{
    ...
    private static readonly string s_scriptFolder = Path.Combine(Path.GetTempPath(), "aray-code-tts", "scripts");
    ...
    private static void ExtractAllScripts()
    {
        ...
        // RootNamespace from csproj is ArayCode — resource names use it, not the assembly name
        var resourcePrefix = "ArayCode.scripts.";
