...
namespace ArayCode.Services.TestMode;
...
public sealed class MockDirectLlmService : IDirectLlmService
{
    ...
    private string GenerateResponse(string message)
    {
        ...
        {
            return "This is test mode for ArayCode. Available commands:\n" +
        ...
        {
            return "I am a mock LLM service for testing ArayCode. I'm not a real AI - I provide predefined responses for development and testing purposes.";
        }
